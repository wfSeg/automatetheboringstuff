#use triple quote ''' to past in text with un-escaped quotes
...
for character in message.upper(): #this assigns each char in message str a key
    count.setdefault(character, 0) #assigns each char a value 0
    count[character] += 1
